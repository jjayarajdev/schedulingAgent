...
echo ""
echo "AWS Status:"
echo "  ✅ All ProjectForce core resources deleted"
echo "  ✅ Clean slate ready for rebuild"
echo ""
echo "⚠️  Voice Integration:"
echo "  📋 Voice resources (if deployed) require separate cleanup"
echo ""
echo "     Full deployment cleanup:"
echo "       ./scripts/CLEANUP_VOICE_FULL.sh"
echo "       Deletes: Connect, Lex, Lambda, phone number, S3, DynamoDB"
echo ""
echo "     Minimal deployment cleanup:"
echo "       ./scripts/CLEANUP_VOICE.sh"
echo "       Deletes: Lambda functions, S3, DynamoDB only"
echo ""
echo "Next Steps:"
echo "  1. Review FINAL_AGENT_ARCHITECTURE.md"
echo "  2. Run: ./scripts/DEPLOY.sh"
echo "  3. Test with: python3 test_deployment.py"
echo "  4. (Optional) Deploy voice: ./scripts/DEPLOY_VOICE_FULL.sh (recommended)"
echo "     Or minimal: ./scripts/DEPLOY_VOICE_MINIMAL.sh"
echo ""
echo "=========================================="
