...
echo "     Run: ./scripts/CLEANUP_VOICE.sh"
echo "     This will delete:"
echo "       - Voice Lambda functions (lex-fulfillment, voice-bedrock-bridge)"
echo "       - S3 bucket (call recordings)"
echo "       - DynamoDB table (session data for voice)"
echo ""
echo "Next Steps:"
echo "  1. Review FINAL_AGENT_ARCHITECTURE.md"
echo "  2. Run: ./scripts/DEPLOY.sh"
echo "  3. Test with: python3 test_deployment.py"
echo "  4. (Optional) Deploy voice: ./scripts/DEPLOY_VOICE_MINIMAL.sh"
echo ""
echo "=========================================="
