#!/bin/bash
# ============================================================================
# PF-SYN VAPI Dashboard - PROD Environment Setup
# Region: us-east-2
# ============================================================================
...
echo "============================================"
echo "Setting up VAPI Dashboard - PROD (us-east-2)"
echo "============================================"
...
# NOTE: For production, create users with secure passwords!
echo "  NOTE: Create production users manually with secure passwords"
...
# us-east-2 requires LocationConstraint
...
# ============================================================================
echo ""
echo "[5/7] Lambda functions will be created by deploy-backend-prod.sh"
...
echo $API_ID > /tmp/api-gateway-id-prod.txt
echo "  API Gateway ID saved to /tmp/api-gateway-id-prod.txt"
...
echo ""
echo "IMPORTANT: Create production users with secure passwords!"
echo ""
echo "Next Steps:"
echo "  1. Run: ./deploy-backend-prod.sh"
echo "  2. Run: ./deploy-frontend-prod.sh"
echo ""
