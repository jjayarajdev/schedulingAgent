...
echo ""
echo " Running: Quick Tests (Sanity Check)"
...
# Run Test Suite 1
echo ""
echo " Running: Test Suite 1 - Basic Workflow"
...
# Run Test Suite 2
echo ""
echo " Running: Test Suite 2 - Context Resolution"
...
# Run Test Suite 3
echo ""
echo " Running: Test Suite 3 - Advanced Filtering"
...
# Run Test Suite 4
echo ""
echo " Running: Test Suite 4 - Mixed Chitchat & Business"
...
# Run Test Suite 5
echo ""
echo " Running: Test Suite 5 - Scheduling Operations"
...
# Run Test Suite 6
echo ""
echo " Running: Test Suite 6 - Notes Functionality"
...
# Run Test Suite 9
echo ""
echo " Running: Test Suite 9 - Weather & Information"
if ./test_suite_9_weather_information.sh > /tmp/test_suite_9.log 2>&1; then
 echo " Test Suite 9: PASSED"
 ((PASSED++))
else
 echo " Test Suite 9: FAILED"
 ((FAILED++))
fi
