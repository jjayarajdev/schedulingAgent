    ...
    intents = [
        ...
        },
        {
            ...
            'utterances': [
                ...
                'done here',
                'nothing more',
                # New utterances added Dec 5 for better goodbye recognition
                'no I am done thanks so much',
                'no im done thanks so much',
                'I am done thanks so much',
                'im done thanks so much',
                'done thanks so much',
                'no thanks so much',
                'thanks so much bye',
